...
// import { FaEnvelope, FaLock, FaLeaf, FaAppleAlt, FaUtensils, FaDrumstickBite, FaBreadSlice, FaFireAlt, FaCalendarAlt, FaUser } from "react-icons/fa";
...
//   return (
//     <div className="min-h-screen bg-emerald-50 dark:bg-gray-900 flex justify-center items-start p-6 relative overflow-hidden text-emerald-900 dark:text-emerald-100">
...
//         className="relative z-10 w-full max-w-lg bg-white/90 backdrop-blur-sm p-8 rounded-3xl shadow-2xl border border-emerald-200/50 space-y-6 animate-fadeIn hover:shadow-emerald/20 transition-shadow duration-500"
//       >
//         <div className="text-center animate-slideInUp">
//           <FaUser className="mx-auto text-5xl text-emerald-600 mb-2 animate-pulse" />
//           <h2 className="text-3xl font-extrabold text-emerald-700 drop-shadow-md inline-block animate-typing">
//             Welcome Back
//           </h2>
//           <p className="text-sm text-emerald-600 mt-1 animate-fadeIn" style={{ animationDelay: '0.5s' }}>Continue your VitalBowl journey</p>
//         </div>
...
//           <label className="flex items-center gap-2 font-medium text-emerald-800">
//             <FaEnvelope className="text-purple-600 transition-colors duration-300 hover:text-purple-700" /> Email
//           </label>
//           <div className="relative group">
//             <input type="email" placeholder="e.g., user@vitalbowl.com" {...formik.getFieldProps("email")} className="w-full p-3 pl-10 rounded-lg border border-emerald-300 focus:ring-4 focus:ring-emerald-400/50 focus:border-emerald-400 transition-all duration-300 bg-white hover:shadow-md" />
//             <FaEnvelope className="absolute left-3 top-1/2 transform -translate-y-1/2 text-purple-500 transition-colors duration-300 group-hover:text-purple-600" />
//           </div>
...
//           <label className="flex items-center gap-2 font-medium text-emerald-800">
//             <FaLock className="text-red-600 transition-colors duration-300 hover:text-red-700" /> Password
//           </label>
//           <div className="relative group">
//             <input type="password" placeholder="Enter your password" {...formik.getFieldProps("password")} className="w-full p-3 pl-10 rounded-lg border border-emerald-300 focus:ring-4 focus:ring-emerald-400/50 focus:border-emerald-400 transition-all duration-300 bg-white hover:shadow-md" />
//             <FaLock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-red-500 transition-colors duration-300 group-hover:text-red-600" />
//           </div>
//           {formik.touched.password && formik.errors.password && <p className="text-red-500 text-xs animate-shake">{formik.errors.password}</p>}
//         </div>

//         <button type="submit" className="w-full bg-gradient-to-r from-emerald-500 to-lime-500 hover:from-emerald-600 hover:to-lime-600 text-white font-bold py-3 rounded-full shadow-md transition-all duration-300 transform hover:scale-105 hover:shadow-lg animate-pulse">
//           Login to VitalBowl 🥗
//         </button>
//       </form>
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-avocadoCream flex justify-center items-start p-6 relative overflow-hidden text-avocadoDarkBrown">
      ...
      {/* Floating avocado & food icons */}
      <FaLeaf className="absolute top-16 left-16 text-avocadoGreen opacity-30 animate-bounce" style={{ animationDelay: '0s' }} />
      <FaUser className="absolute top-32 right-20 text-avocadoGreen opacity-20 animate-bounce" style={{ animationDelay: '1s' }} />
      <FaUtensils className="absolute bottom-20 left-20 text-avocadoGreen opacity-25 animate-bounce" style={{ animationDelay: '2s' }} />
      <FaAppleAlt className="absolute bottom-32 right-24 text-avocadoDarkGreen opacity-25 animate-bounce" style={{ animationDelay: '3s' }} />
      ...
      <form
        onSubmit={formik.handleSubmit}
        className="relative z-10 w-full max-w-lg bg-white/90 backdrop-blur-sm p-8 rounded-3xl shadow-2xl border border-avocadoGreen/50 space-y-6 animate-fadeIn hover:shadow-avocadoGreen/20 transition-shadow duration-500"
      >
        <div className="text-center animate-slideInUp">
          ...
          <p className="text-sm text-avocadoGreen mt-1 animate-fadeIn" style={{ animationDelay: '0.5s' }}>
            Continue your VitalBowl journey
          </p>
        </div>
        ...
        <div className="flex flex-col animate-slideInUp" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="relative group">
            <input type="password" placeholder="Enter your password" {...formik.getFieldProps("password")} className="w-full p-3 pl-10 rounded-lg border border-avocadoGreen focus:ring-4 focus:ring-avocadoGreen/50 focus:border-avocadoGreen transition-all duration-300 bg-white hover:shadow-md" />
        ...
        <button type="submit" className="w-full bg-gradient-to-r from-avocadoGreen to-avocadoDarkGreen hover:from-avocadoLightGreen hover:to-avocadoGreen text-white font-bold py-3 rounded-full shadow-md transition-all duration-300 transform hover:scale-105 hover:shadow-lg animate-pulse">
          Login to VitalBowl 🥗
        </button>
      </form>
      ...
      <style>{`
        ...
        .animate-typing { display:inline-block; overflow:hidden; border-right:2px solid; white-space:nowrap; animation: typing 2s steps(20,end) forwards, blink-caret 0.75s step-end 5 forwards; }
